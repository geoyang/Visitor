#!/usr/bin/env python3
"""
Simple super admin creation using pymongo directly
"""
import hashlib
...
def create_super_admin():
    """Create super admin account using pymongo"""
    # MongoDB connection
    ...
    existing_admin = companies_collection.find_one({"account_email": admin_email})
    if existing_admin:
    ...
    # Insert super admin
    result = companies_collection.insert_one(super_admin_data)
